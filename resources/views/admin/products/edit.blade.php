                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control"
                                                value="{{$products->title}}" placeholder="Title">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="10" class="summernote"
                                                placeholder="Shipping and Returns">{{$products->shipping_returns}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="compare_price" id="compare_price"
                                                class="form-control" value="{{$products->compare_price}}" placeholder="Compare Price">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="status" id="status" class="form-control">
                                        <option {{($products->status==1)? 'selected' :''}}
                                            value="1">Active</option>
                                        <option {{($products->status==0)? 'selected' :''}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control">
                                        <option value="">Sub a Sub Category</option>
...
@section('customJs')
    <script>
        ...
        function deleteImage(id){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this even if you cancel the update process!",
                icon: "warning",
                showDenyButton: true,
                ...
                if (result.isConfirmed) {
                    ...
                    $("#image-row-"+id).remove();
                    $.ajax({
                        url: '{{ route("products-images.destroy","$products->id")}}',
                        type: 'delete',
                        data: {id:id},
                        success: function(response) {
                            if(response.status == true) {
                                Swal.fire("Image delete cancel  ", "", "success")
                            }
                        }
                    });
