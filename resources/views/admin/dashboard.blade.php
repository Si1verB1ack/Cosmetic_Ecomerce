		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-4 col-6">
					<div class="small-box card">
						<div class="inner">
							<h3>${{number_format($totalRevenues,2)}}</h3>
							<p>Total Sale</p>
						</div>
						<div class="icon">
				...
				<div class="col-lg-4 col-6">
					<div class="small-box card">
						<div class="inner">
							<h3>${{number_format($revenuesThisMonth,2)}}</h3>
				...
				<div class="col-lg-4 col-6">
					<div class="small-box card">
						<div class="inner">
							<h3>${{number_format($revenuesLastMonth,2)}}</h3>
				...
				<div class="col-lg-4 col-6">
					<div class="small-box card">
						<div class="inner">
							<h3>${{number_format($revenuesLast30day,2)}}</h3>
